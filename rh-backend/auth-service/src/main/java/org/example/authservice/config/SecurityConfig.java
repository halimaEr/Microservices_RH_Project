...
//                                .requestMatchers("/common/**").hasAnyAuthority("Admin", "Responsable", "Gestionnaire")
//                                .requestMatchers("/responsable-and-gestionnaire/**").hasAnyAuthority("Responsable","Gestionnaire")
                                .requestMatchers("/**")
                                .permitAll()
                                .anyRequest()
                                .authenticated()
